          ...
          >
            <div>
              ...
              <div className="myCarousel">
                ...
                <p>
                  ...
                  Her facility with visual collaboration software, keen
                  perception of user experience, and solution-oriented approach
                  to code clarified the user flow diagram and the resulting
                  functionality to be built in our React Native mobile app. Her
                  timely questions led us to build a product with a quicker,
                  smoother, and more logical onboarding process. I look forward
            ...
            <div>
              ...
              <div className="myCarousel">
                ...
                <p>
                  Dona is one of the most proactive and thoughtful developers
                  I've ever worked with. Her attention to detail has helped our
                  team think ahead about potential improvement opportunities and
                  her contributions have enhanced the user experience of our
                  product. Dona's work ethic and responsiveness set an example
                  for her entire team and has brought about a sense of
                  confidence and commitment that helps the whole team build
                  better. She has been a key part of how our team has arrived at
                  better solutions for our product and I highly recommend her on
                  your project.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="myCarousel">
                ...
                <p>
                  ...
                  Dona is always the hardest worker on the team. She
                  consistently strives to do her best possible work, and her
                  love of learning is inspiring to those around her. During boot
                  camp, there were times Dona would help me teach her classmates
                  complex concepts in JavaScript and React. As tech lead, I
                  always assigned Dona the most challenging tickets with full
                  confidence in her ability to complete them on time, even when
                  they required her to learn new skills. Dona is kind, humble,
                  dependable, and brilliant. She will not squander any
                  opportunity that comes her way and I give her my full
                  recommendation.
                </p>
              </div>
            </div>
